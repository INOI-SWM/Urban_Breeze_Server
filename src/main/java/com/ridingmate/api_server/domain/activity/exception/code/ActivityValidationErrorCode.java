...
public enum ActivityValidationErrorCode implements ErrorCode {
    INVALID_ACTIVITY_TITLE(HttpStatus.BAD_REQUEST, "INVALID_ACTIVITY_TITLE", "주행 기록 제목이 유효하지 않습니다."),
    INVALID_ACTIVITY_DATE_RANGE(HttpStatus.BAD_REQUEST, "INVALID_ACTIVITY_DATE_RANGE", "주행 기록 시작 시간이 종료 시간보다 늦을 수 없습니다."),
    ...
    FUTURE_ACTIVITY_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FUTURE_ACTIVITY_NOT_ALLOWED", "미래 시간의 주행 기록은 생성할 수 없습니다."),
